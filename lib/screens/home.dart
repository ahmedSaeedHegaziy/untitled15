...
import 'package:untitled15/screens/all_senders.dart';
import 'package:untitled15/screens/manage_users.dart';
import 'package:untitled15/screens/new_inbox.dart';
import 'package:untitled15/screens/profile.dart';
import 'package:untitled15/screens/crateaccount.dart';
import 'package:untitled15/screens/search_screen.dart';
import 'package:untitled15/screens/search_with_tag.dart';
import 'package:untitled15/services/user_service.dart';

import 'package:untitled15/widgets/myAppBar.dart';
import 'package:untitled15/widgets/myGridView.dart';
                        ...
                        children: [
                          ...
                          ListTile(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  settings:
                                  const RouteSettings(name: "/AddUser"),
                                  builder: (
                                      context) => const RegisterScreen()));
                            },
                            leading: Icon(Icons.person_add_alt),
                            title: Text('Add Users'.tr()),
                          ),
                        ],
                      );
                    } else {
                ...
                children: [
                  ...
                  RefreshIndicator(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: const HomeScreenWidgets(mails: [
                      ], statuses: [],),
                    ),
                  ),
                  MyAppBar(
